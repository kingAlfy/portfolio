...
import { SiSpring, SiJavascript, SiReact, SiPhp, SiLaravel, SiMysql, SiSymfony, SiApache } from "react-icons/si";
        ...
        <div className="skillsContainer">
            ...
            <IconContext.Provider value={{ size: "60px" }}>
                <div className="skillsContainer-div">
                    ...
                    <a className="skillsContainer-tooltip--symfony">
                        <div className="skillsContainer-svg">
                            <SiSymfony />
                        </div>
                    </a>
                    ...
                    <a className="skillsContainer-tooltip--apache">
                        <div className="skillsContainer-svg">
                            <SiApache />
                        </div>
                    </a>
                ...
                <Tooltip anchorSelect=".skillsContainer-tooltip--symfony" content="Symfony" className="skillsContainer-tooltip" />
                <Tooltip anchorSelect=".skillsContainer-tooltip--apache" content="Apache" className="skillsContainer-tooltip" />
